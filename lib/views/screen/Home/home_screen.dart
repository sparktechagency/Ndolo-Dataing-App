...
class _HomeScreenState extends State<HomeScreen> {
                ...
                child: Column(
                  children: [
                    ...
                    _allSwiped
                      ...
                      child: TCard(
                        controller: _cardController,
                        size: Size(double.infinity, double.infinity), // Constrained height
                              ...
                              Positioned(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Icon(Icons.location_on, color: Colors.white, size: 14.h),
                                        SizedBox(width: 4.w),
                                        CustomText(
  ...
  Widget _slideButton(Widget icon, Color borderColor) {
    return Container(
      ...
      child: Padding(padding: EdgeInsets.all(12.w), child: icon),
    );
  }
}
